...
class ConnectionEventHandler(pyngus.ConnectionEventHandler):
    def connection_failed(self, connection, error):
        ...
        LOG.warning("Connection failed: %s", error)
        connection.close()
...
class interchange:
    def __init__(self, server, ca, ssl_cert_file, ssl_key_file, ssl_key_password,source):
    ...
    #
        ...
        conn_properties["x-ssl-identity"] = (ssl_cert_file,
                                             ssl_key_file,
                                             ssl_key_password)
...
#     sys.exit(main())
        ...
        #                   help="Password to unlock SSL key file", default=None)
